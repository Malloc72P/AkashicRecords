...
public class guestBookDAO {
	...
	public guestBookDAO() {
		...
		try {
			...
			System.out.println("guestBookDAO Constructor >>> " + pool);
		} catch (Exception e) {
			System.out.println("guestBookDAO Constructor >>> "+"DBConnection 인스턴스 획득 실패");
		}
	...
	public int getArticleCount() {
		...
		try {
			...
			String sql = "select count(*) from aka_guestBoard";// select count(*) from member
	...
	public List getArticles(int start, int end) {
		...
		try {
			...
			String sql = "select * from aka_guestBoard order by num desc limit ?,?";
			queryOBJ = connDB.prepareStatement(sql);
